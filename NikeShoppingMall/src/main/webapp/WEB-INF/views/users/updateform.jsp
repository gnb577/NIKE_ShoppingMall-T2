...
<div class="container" style="height:1500px;">
	...
	<form action="${pageContext.request.contextPath}/users/update.do" method="post" id="myForm">
		<input type="hidden" name="profile" value="${param.users_id}"/>

		<div style="text-align:center;">
			<label class="control-label" for="id">아이디</label>
			<input class="form-control" type="text" name="id" id="id" value="${param.users_id }" disabled/>
			<br />
		...
		<div style="text-align:center;">
			...
			<input class="form-control" type="text" name="email" id="email" value="${dto.users_email }"/>
			<div class="invalid-feedback">이메일 형식을 확인 하세요.</div>
		</div>
		<div style="text-align:center;">
			<label class="control-label" for="name1">이름</label>
			<input class="form-control" type="text" name="name1" id="name1" value="${dto.users_name }"/>
		</div>
		<div style="text-align:center;">
			<label class="control-label" for="text">생년월일</label>
			<input class="form-control" type="number" name="birth" id="birth" value="${dto.users_birthday }"/>
			
		</div>
		<div style="text-align:center;">
			<label class="control-label" for="phonenumber">연락처</label>
			<input class="form-control" type="text" name="phonenumber" id="phonenumber" value="${dto.users_phoneNum }"/>
		</div>
		<div style="text-align:center;">
			<label class="control-label" for="adress">주소</label>
			<input class="form-control" type="text" name="adress" id="adress" value="${dto.users_addr }"/>
		</div >
		<div style="text-align:center; margin-top:80px; padding-top:40px; border-top:1px solid;">
		<button class="btn btn-primary" type="submit">수정하기</button>
		<button class="btn" type="submit" onclick="location.href='${pageContext.request.contextPath }/users/delete.do'" style="margin-left:20px;">탈퇴하기</button>
		</div>
	</form>
