		...
		<div>
  			...
  			<div>
  				<div class="row" style="padding: 0px;">
  					...
  					<div class="col-10">
  						<div style="border-top: 1px solid #d3d3d3; border-bottom: 1px solid #d3d3d3; height:60px; display:flex; justify-content:left; align-items:center; font-size:16px; padding-left:10px;">${tmp.user_name }</div>
  						<div style="border-bottom: 1px solid #d3d3d3; height:60px; display:flex; justify-content:left; align-items:center; font-size:16px; padding-left:10px;">${tmp.users_email }</div>
  						<div style="border-bottom: 1px solid #d3d3d3; height:60px; display:flex; justify-content:left; align-items:center; font-size:16px; padding-left:10px;">${tmp.user_phoneNum } <br />쿠폰/티켓 정보는 구매한 분의 번호로 전됩니다.</div>
  					</div>
  				</div>
  			</div>
  		</div>  
		...
		<div>
  			...
  			<div>
  				<div class="row" style="padding: 0px;">
  					...
  					<div class="col-10">
  						<div style="border-top: 1px solid #d3d3d3; border-bottom: 1px solid #d3d3d3; height:60px; display:flex; justify-content:left; align-items:center; font-size:16px; padding-left:10px;">${tmp.user_name }</div>
  						<div style="border-bottom: 1px solid #d3d3d3; height:60px; display:flex; justify-content:left; align-items:center; font-size:16px; padding-left:10px;">${tmp.user_addr }</div>
  						<div style="border-bottom: 1px solid #d3d3d3; height:60px; display:flex; justify-content:left; align-items:center; font-size:16px; padding-left:10px;">${tmp.user_phoneNum }</div>
